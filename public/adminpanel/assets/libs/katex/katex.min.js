        ...
        function (t, e, r) {
                    ...
                    function t(t) {
                        (this.displayMode = void 0),
                            ...
                            (this.maxSize = Math.max(
                                0,
                                c.deflt(t.maxSize, 1 / 0)
                            )),
                            (this.maxExpand = Math.max(
                                0,
                                c.deflt(t.maxExpand, 1e3)
                            ));
                    }
                    var e = t.prototype;
                    return (
                    ...
                    makeOrd: function (t, e, r) {
                        ...
                        if ("textord" === r) {
                            ...
                            return qt(
                                ...
                                n,
                                e,
                                s.concat(e.fontWeight, e.fontShape)
                            );
                        }
                        throw new Error(
                ...
                for (
                    var e = t.type,
                        ...
                        s = {
                            ...
                            argTypes: a.argTypes,
                            greediness:
                                void 0 === a.greediness ? 1 : a.greediness,
            ...
            function de(t, e) {
                ...
                o.length > 0 && i.push(pe(o, e)),
                    r &&
                        (((a = pe(se(r, e, !0))).classes = ["tag"]), i.push(a));
                    ...
                    SpaceNode: (function () {
                        ...
                        return (
                            (e.toNode = function () {
                                ...
                                return (
                                    t.setAttribute("width", this.width + "em"),
                                    t
                                );
                            }),
                            (e.toMarkup = function () {
                    ...
                    return (
                        !j[e][t] ||
                            ...
                            (rt.hasOwnProperty(t) &&
                                r &&
                                ((r.fontFamily &&
                                    "tt" === r.fontFamily.substr(4, 2)) ||
                                    (r.font &&
                                        "tt" === r.font.substr(4, 2)))) ||
                            (t = j[e][t].replace),
                        new ve.TextNode(t)
                    );
                },
                ...
                Oe = function (t, e) {
                    var r = (function () {
                            ...
                            for (var w = 0; w < y; w++) {
                                ...
                                if (1 === y)
                                    return { span: M, minWidth: x, height: b };
            ...
            Qt({
                ...
                Qt({
                    ...
                    handler: function (t, e) {
                        ...
                        if (isNaN(s))
                            throw new o(
                                "\\@char has non-numeric argument " + n
                            );
                        return {
                            type: "textord",
                            mode: r.mode,
                    ...
                    htmlBuilder: function (t, e) {
                        ...
                        return (
                            t.newLine &&
                                ...
                                t.size &&
                                    (r.style.marginTop = Tt(t.size, e) + "em")),
                            r
                        );
                    },
                    mathmlBuilder: function (t, e) {
            ...
            var Ve = function (t, e, r) {
                ...
                _e = function (t, e, r, a, n, i) {
                    ...
                    return Ue(
                        Dt.makeSpan(["delimsizing", "mult"], [I], N),
                        w.TEXT,
                        a,
                        i
                    );
                ...
                ir = function (t, e) {
                    var r,
                        ...
                        s = Math.max(
                            0,
                            e.minRuleThickness -
                                e.fontMetrics().sqrtRuleThickness
                        ),
                        h = 0,
                        l = 0,
                        m = 0;
                    return (
                        "small" === i.type
                            ...
                            : ((h = t + s + 0.08),
                              ...
                              ((r = je("sqrtTall", h, m, s, e)).style.minWidth =
                                  "0.742em"),
                              (a = 1.056)),
                        (r.height = l),
                        (r.style.height = h + "em"),
                        {
                            ...
                            advanceWidth: a,
                            ruleWidth:
                                (e.fontMetrics().sqrtRuleThickness + s) * o,
                        }
                    );
                },
                    ...
                    mathmlBuilder: function (t, e) {
                        ...
                        if ("." !== t.right) {
                            ...
                            n.setAttribute("fence", "true"),
                                t.rightColor &&
                                    n.setAttribute("mathcolor", t.rightColor),
                                r.push(n);
                        }
                        return ye(r);
                    },
                    ...
                    for (a = 0, q = 0; a < s || q < I.length; ++a, ++q) {
                        for (
                            ...
                            if (
                                ...
                                throw new o(
                                    "Invalid separator type: " + O.separator
                                );
                ...
                kr = function (t, e) {
                    ...
                    if (t.cols) {
                        ...
                        r.setAttribute("columnalign", i.trim()),
                            /[sd]/.test(s) &&
                                r.setAttribute("columnlines", s.trim());
                    }
            ...
            gr({
                ...
                gr({
                    ...
                    handler: function (t, e) {
                        var r = (
                            Yt(e[0]) ? [e[0]] : Ft(e[0], "ordgroup").body
                        ).map(function (t) {
                            var e = Gt(t).text;
                            if (-1 !== "lc".indexOf(e))
                                return { type: "align", align: e };
            ...
            Qt({
                ...
                mathmlBuilder: function (t, e) {
                    ...
                    return (
                        n.setAttribute("mathsize", r.sizeMultiplier + "em"), n
                    );
                },
            }),
                Qt({
            ...
            te({
                ...
                mathmlBuilder: function (t, e) {
                    var r = new ve.MathNode("mi", [be(t.text, t.mode, e)]),
                        a = we(t, e) || "italic";
                    return (
                        a !== Zr[r.type] && r.setAttribute("mathvariant", a), r
                    );
                },
            }),
                te({
                    ...
                    return (
                        ...
                        (e.lex = function () {
                            ...
                            return (
                                ...
                                new n(
                                    i,
                                    new a(this, e, this.tokenRegex.lastIndex)
                                )
                            );
                        }),
                        t
                ...
                Ma = (function () {
                    ...
                    return (
                        ...
                        (e.parse = function () {
                            ...
                            return (
                                this.expect("EOF"), this.gullet.endGroup(), t
                            );
                        }),
                        ...
                        (e.parseFunction = function (t, e, r) {
                            ...
                            if (!i) return null;
                            if (
                                (this.consume(), null != r && i.greediness <= r)
                            )
                                throw new o(
                                    "Got function '" +
                                        n +
                        ...
                        (e.parseStringGroup = function (t, e, r) {
                            ...
                            return (
                                this.expect(n), (this.mode = s), m.range(u, l)
                            );
                        }),
